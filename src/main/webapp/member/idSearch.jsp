...
<body>
	...
	<div>
	 	<div>
	        ...
	        <form name="agreeform" id="agreeform" action="idSearchProcess.jsp" method=post> 
	            <div style="margin: auto; " class="square" >
	                ...
	                <p style="text-align: center;"><strong>아이디가 기억나지 않으세요?</strong><br>아래 인증 방법을 통해 아이디를 확인 하실 수 있습니다.</p>
	            </div>
	            
	                
	            <%--휴대폰, 아이핀 인증 단계 삭제 --%>
	            <div class="square">
	                <h4><strong>인증하기</strong></h4>
	           		<div style="text-align : center;">
	           			...
	           			<%--2021.10.05 확인 버튼클릭시 idSearchProcess.jsp으로 이동. --%>
